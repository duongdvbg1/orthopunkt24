...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    )
    {
        ...
        $this->hide_files_icon = (bool)trim($this->_scopeConfig->getValue('itm_magb1_section/general/hide_files_icon', \Magento\Store\Model\ScopeInterface::SCOPE_STORE));
        $this->delete_media_external = (bool)trim($this->_scopeConfig->getValue('itm_magb1_section/general/delete_media_external', \Magento\Store\Model\ScopeInterface::SCOPE_STORE));
        ...
        $this->display_general_infomration = (bool)trim($this->_scopeConfig->getValue('itm_magb1_section/general/display_general_infomration'));
        $dgi_customer_attributes = trim($this->_scopeConfig->getValue('itm_magb1_section/general/dgi_customer_attributes'));
        $this->paymentMethodList = $paymentMethodList;
        // coming from the pricing ext.
        $this->_ignoreUom = (bool)trim($this->_scopeConfig->getValue('itm_pricing_section/general/ignore_uom'));

        $this->useIncrementId = (bool)trim($this->_scopeConfig->getValue('itm_magb1_section/general/use_increment_id'));
        $this->updateInventoryReservation = (bool)trim($this->_scopeConfig->getValue('itm_magb1_section/general/update_inventory_reservation'));


        $dgi_groups = trim($this->_scopeConfig->getValue('itm_magb1_section/general/dgi_customer_groups'));
    ...
    public function allowedToSeeTheFiles()
    {
        ...
        $hide_files_tab_customer_group = trim($this->_scopeConfig->getValue('itm_magb1_section/general/hide_files_tab_customer_group', \Magento\Store\Model\ScopeInterface::SCOPE_STORE));
        $hide_files_tab_customer_group = trim($hide_files_tab_customer_group);
